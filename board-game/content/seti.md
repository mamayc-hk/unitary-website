...
SETI: 搜尋地外文明 嘅核心機制係「自家計劃板 + 太陽系圖版」嘅雙層行動系統: 每個玩家自己嘅 Mothership 板 (類似自家 board) 上面 plan 5 round 嘅行動, 行動包括發射訊號、探測行星、收集外星數據、升級技術。執行階段, 探測器會喺太陽系圖版飛行, 喺行星上收集樣本, 帶返地球分析。中重歐設計令 SETI: 搜尋地外文明 有 4 個主要得分路徑: 外星文明卡 (高難度高 VP)、行星卡 (穩定得分)、技術升級 (長期優勢)、訊號任務 (短期 bonus)。
...
1. **「訊號 track = 免費 action」**: 發射 1 個訊號 = 1 Energy, 但訊號行到 track 對應位置會觸發免費 action (例如再行 1 格探測器, 免費升級, 免費資源)。高手會計算「邊個 track 位置最抵」, 唔係亂發訊號。建議: 第 1 round 計劃時已經要想 track 4-5 嘅 bonus 觸發。

2. **「探測器 move vs upgrade」**: 每 round 探測器可以行 1-2 格, 但升級可以 +1 速度, 即係升滿嘅探測器 1 round 行 3-4 格。高手會優先升級 1-2 隻探測器去「搶高 VP 行星」, 唔係分散升級 3 隻。

3. **「外星文明卡 = 高風險高回報」**: 外星卡 8-15 VP, 對比行星卡 2-5 VP, 但外星卡需要「hit 對應區域」, 概率低 (1/6 to 1/3)。高手會保留 1-2 個探測器做「外星探測專用」, 其他探測器做「行星收集」。

4. **「單人場: 自動對手代替」**: 單人場 SETI: 搜尋地外文明 有自動對手 (Automa), 玩法同多人場類似, 但 Automa 自動做基本行動 (收集行星, 發訊號), 你做玩家行動 (升級 / 探外星 / 大決策)。單人場適合練習 plan + execute 嘅節奏, 唔需要 4 個朋友約時間。

5. **「1-4 人場都係 plan-execute」**: SETI: 搜尋地外文明 唔似 卡坦島 (Catan) 咁有「等其他人」嘅 downtime, plan 階段各自 plan, execute 階段各自執行。1 人 90 min, 2 人 100 min, 4 人 120 min, downtime 唔係線性增加, 所以 4 人場最抵。

6. **「技術升級優先順序」**: 3 個升級 (速度 / 負載 / 掃描) 之中, 速度 +1 通常最抵 (影響所有探測器 move), 負載 +1 第二 (多 1 個數據), 掃描 +1 第三 (只 hit 外星先用)。高手順序: 速度 > 負載 > 掃描。

## Tiebreaker

SETI: 搜尋地外文明 嘅 tiebreaker (官方規則書 page 16):

1. **主規則**: VP 多者勝, 已喺 Step 8 結算。
2. **平手 (第一次 tiebreaker)**: 比較「外星文明卡總數」, 多者勝 (因為外星卡難 hit, hit 到即係高手)。
3. **再平手 (第二次 tiebreaker)**: 比較「行星卡總數」, 多者勝 (行星卡穩定, 反映探測器控制力)。
4. **再平手 (第三次 tiebreaker)**: 比較「訊號 token 數量」, 多者勝 (訊號代表 plan 深度)。
5. **再平手 (罕有)**: 共享勝 (Cooperative win, 5 round 玩完所有玩家 +10 VP bonus)。
...
- **「1 個人想玩 strategy game」**: SETI: 搜尋地外文明 單人場有 Automa 自動對手, 適合 1 個人練習 plan-execute 節奏, 90 min 玩完。
- **「太空主題, 有咩 game?」**: SETI: 搜尋地外文明 太空主題, 2024 年新版, 旺角太空愛好者首選, 但中文版暫時只有英文版 (CGE 官方)。
- **「90 min 內想完一局」**: SETI: 搜尋地外文明 一局 90-120 min, 90 分鐘會超時。建議預 2 小時, 玩晒 5 round。
...
- **新手可以 demo 半局**: SETI: 搜尋地外文明 教學時間長, 建議新手第一次玩 demo 半局 (round 1-2), 再正式 play 5 round。

## 參考

- [BGG: SETI: Search for Extraterrestrial Intelligence](https://boardgamegeek.com/boardgame/418059/seti-search-extraterrestrial-intelligence)
- Notion 8/8 review 校稿: 2026-08-11 (Mavis 自動補)
- 官方規則書: CGE 2024 (Vlaada Chvátil 設計)
- 旺角供應: 英文版 (CGE 官方), 中文版暫時未有
