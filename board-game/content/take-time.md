...
1. **「唔講具體數字」係鐵律**: Notion 8/8 review 提到, Take Time 嘅 design 故意限制語言。如果有玩家話「我手上有一張 7」, 等於破壞默契嘅設計, 失去咗 Take Time 嘅精髓。新手可以 demo 一次「抽象語言」嘅表達: 用「大 / 中 / 細」、「奇 / 偶」、「連續 / 跳」等形容詞。高手表達方式係「我有 2 張細同 1 張大, 細嘅 1 張係 0」, 唔直接講 7, 但暗示咗「我有 1 張大」。
...
5. **「默契 > 表達」**: Take Time 嘅設計刻意限制語言, 係要玩家「諗對方會出咩」而唔係「叫對方出咩」。高手打法係「如果你覺得佢會出 5, 你就出 5」, 唔係「我覺得應該出 5」, 兩者好唔同。你可以 demo: 同一個牌局, 兩個玩家用唔同 strategy, 一個諗「我自己」, 一個諗「對方」, 結果諗對方嗰個贏。
